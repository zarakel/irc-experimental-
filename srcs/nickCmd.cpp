...
int	NICK(int poll_fd, Stock *Stock)
{
	...
	{
		Stock->Identities[Stock->User][1].erase(0, 
			Stock->Identities[Stock->User][1].size());
		Stock->Identities[Stock->User][1] = Stock->line[1];
		Stock->Nicks[Stock->User].erase(0, Stock->Nicks[Stock->User].size() );
